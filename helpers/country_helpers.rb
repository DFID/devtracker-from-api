module CountryHelpers
  ...
  def get_country_or_region(projectId)
      ...
      # end
      countryOrRegionAPI = RestClient.get settings.oipa_api_url + "activities/?activity_id=#{projectId}&fields=iati_identifier,recipient_countries,recipient_regions&format=json&page_size=500"
