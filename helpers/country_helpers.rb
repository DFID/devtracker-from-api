module CountryHelpers
  ...
  def get_top_5_countries()
      ...
      # Solr endpoint below
      puts settings.oipa_api_url_solr + 'budget?q=participating_org_ref:GB-* AND reporting_org_ref:('+settings.goverment_department_ids.gsub(","," OR ")+') AND budget_period_start_iso_date:['+firstDayOfFinYear.to_s+'T00:00:00Z TO '+lastDayOfFinYear.to_s+'] AND budget_period_end_iso_date:['+firstDayOfFinYear.to_s+' TO '+lastDayOfFinYear.to_s+'T00:00:00Z]&json.facet={"items":{"type":"terms","field":"recipient_country_code","limit":10,"offset":0,"sort":"value desc","facet":{"value":"sum(budget_value)","name":{"type":"terms","field":"recipient_country_name","limit":1},"region":{"type":"terms","field":"recipient_region_code","limit":1}}}}&rows=0'
      top5countriesJSON = RestClient.get  api_simple_log(settings.oipa_api_url_solr + 'budget?q=participating_org_ref:GB-* AND reporting_org_ref:('+settings.goverment_department_ids.gsub(","," OR ")+') AND budget_period_start_iso_date:['+firstDayOfFinYear.to_s+'T00:00:00Z TO '+lastDayOfFinYear.to_s+'T00:00:00Z] AND budget_period_end_iso_date:['+firstDayOfFinYear.to_s+'T00:00:00Z TO '+lastDayOfFinYear.to_s+'T00:00:00Z]&json.facet={"items":{"type":"terms","field":"recipient_country_code","limit":10,"offset":0,"sort":"value desc","facet":{"value":"sum(budget_value)","name":{"type":"terms","field":"recipient_country_name","limit":1},"region":{"type":"terms","field":"recipient_region_code","limit":1}}}}&rows=0')
  ...
  def get_country_details(countryCode)
      ...
      currentTotalCountryBudget = JSON.parse(RestClient.get  api_simple_log(settings.oipa_api_url_solr + 'budget?q=participating_org_ref:GB-* AND reporting_org_ref:('+settings.goverment_department_ids.gsub(","," OR ")+') AND budget_period_start_iso_date:['+firstDayOfFinYear.to_s+'T00:00:00Z TO *] AND budget_period_end_iso_date:[* TO '+lastDayOfFinYear.to_s+'T00:00:00Z] AND recipient_country_code:'+countryCode+'&json.facet={"items":{"type":"terms","field":"recipient_country_code","limit":-1,"sort":"value desc","facet":{"value":"sum(budget_value)","name":{"type":"terms","field":"recipient_country_name","limit":1},"region":{"type":"terms","field":"recipient_region_code","limit":1}}}}&rows=0'))
  ...
  def total_country_budget_location
    ...
    totalCountryBudgetLocation = RestClient.get  api_simple_log(settings.oipa_api_url_solr + 'budget?q=participating_org_ref:GB-* AND reporting_org_ref:('+settings.goverment_department_ids.gsub(","," OR ")+') AND budget_period_start_iso_date:['+firstDayOfFinYear.to_s+'T00:00:00Z TO *] AND budget_period_end_iso_date:[* TO '+lastDayOfFinYear.to_s+'T00:00:00Z]&json.facet={"items":{"type":"terms","field":"recipient_country_code","limit":-1,"sort":"value desc","facet":{"value":"sum(budget_value)","name":{"type":"terms","field":"recipient_country_name","limit":1},"region":{"type":"terms","field":"recipient_region_code","limit":1}}}}&rows=0')
    totalCountryBudgetLocation = JSON.parse(totalCountryBudgetLocation)
    totalAmount = 0.0
    totalCountryBudgetLocation['facets']['items']['buckets'].each do |countryBudgets|
      #oipa 2.2
