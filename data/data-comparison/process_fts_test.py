...
fts_urls = {
        ...
        "solr_sectors": 'https://iatidatastore.iatistandard.org/search/activity/?facet=on&facet.field=sector_code&facet.limit=-1&facet.mincount=1&q=activity_status_code:2 AND hierarchy:1 AND participating_org_ref:GB-GOV-* AND  (title_narrative:"Ethiopia" OR description_narrative:"Ethiopia" OR iati_identifier:"Ethiopia" OR transaction_description_narrative:"Ethiopia" OR reporting_org_ref:"Ethiopia")',
        ...
        "solr_implementing": 'https://iatidatastore.iatistandard.org/search/activity/?facet=on&facet.field=participating_org_ref&facet.limit=-1&facet.mincount=1&q=activity_status_code:2 AND hierarchy:1 AND participating_org_ref:GB-GOV-* AND participating_org_role:4 AND  (title_narrative:"Ethiopia" OR description_narrative:"Ethiopia" OR iati_identifier:"Ethiopia" OR transaction_description_narrative:"Ethiopia" OR reporting_org_ref:"Ethiopia")',
