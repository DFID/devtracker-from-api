                ...
                $.getJSON(pagedOipaLink,{
                    ...
                    $.each(json.results,function(i,result){
                       ...
                       //Check title
                        ...
                        var tempString = '<div class="search-result"><h3><a href="/cw/projects/'+validResults['id']+'">'+validResults['title']+'</a></h3><span>Reporting Org: <em>'+validResults['reporting_organisations']+'</em></span><span>IATI Identifier: <em>'+ validResults['iati_identifier'] +'</em></span><span>Status: <em>'+validResults['activity_status']+'</em></span><span class="budget">Budget: <em> '+'<div class="tpcbcv"><span class="total_plus_child_budget_currency_value_amount">'+validResults['total_plus_child_budget_value']+'</span><span class="total_plus_child_budget_currency_value_cur">'+validResults['total_plus_child_budget_currency']+'</span></div>'+'</em></span><p class="description">'+validResults['description']+'</p></div>';
