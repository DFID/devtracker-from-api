...
window.GOVUKPrototypeKit.documentReady(() => {
     ...
     document.querySelectorAll(".tab_section_3").forEach(function(el) {
          el.addEventListener("click", function() {
               ...
               document.querySelector(".tab_section_2").classList.remove("active");
               document.querySelector(".tab_section_1").classList.remove("active");
          });
     });
     ...
     // Show tab 2
     document.querySelector(".tab_section_2").addEventListener("click", function() {
          document.getElementById("tab_content_3").style.display = "none";
          document.getElementById("tab_content_4").style.display = "none";
          document.getElementById("tab_content_1").style.display = "none";
          document.getElementById("tab_content_2").style.display = "block";
          document.getElementById("tab_content_2").scrollIntoView({ behavior: "smooth"});
          document.getElementById("dashboard_V1_content").classList.add("active");
     });

     document.querySelectorAll(".tab_section_2").forEach(function(el) {
          el.addEventListener("click", function() {
               this.classList.add("active"); // "this" refers to the clicked element
               document.querySelector(".tab_section_3").classList.remove("active");
               document.querySelector(".tab_section_4").classList.remove("active");
     ...
     // Show tab 1
     document.querySelector(".tab_section_1").addEventListener("click", function() {
          document.getElementById("tab_content_3").style.display = "none";
          document.getElementById("tab_content_4").style.display = "none";
          document.getElementById("tab_content_2").style.display = "none";
          document.getElementById("tab_content_1").style.display = "block";
          document.getElementById("tab_content_1").scrollIntoView({ behavior: "smooth"});
          document.getElementById("dashboard_V1_content").classList.add("active");
     });

     document.querySelectorAll(".tab_section_1").forEach(function(el) {
          el.addEventListener("click", function() {
               this.classList.add("active"); // "this" refers to the clicked element
               document.querySelector(".tab_section_3").classList.remove("active");
               document.querySelector(".tab_section_4").classList.remove("active");
